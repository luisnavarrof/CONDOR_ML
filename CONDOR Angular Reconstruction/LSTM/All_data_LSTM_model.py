...
# Directorios
input_base_dir = r"C:\Users\Froxo\OneDrive - Universidad Técnica Federico Santa María\CONDOR_8E2Energy_1000_output_proton\particles_data"
predicts_dir = r"C:\Users\Froxo\OneDrive - Universidad Técnica Federico Santa María\ML_Predictions\Predicts_LSTM_proton_8E2GeV_alldata"
...
def create_sequences(data, time_steps=100):
    ...
    features = data[['x', 'y', 't', 'E']].values  # Agregando energía E como característica
...
for run_folder in os.listdir(input_base_dir):
    ...
    if os.path.isdir(run_path) and "run_" in run_folder:
        ...
        if 1 <= run_number <= 13:  # Ajustar rango si es necesario
...
stats_path = os.path.join(predicts_dir, 'LSTM_predictions_photon8E2GeV_80_epochs_alldata.csv')
